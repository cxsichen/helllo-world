...
public class DBConstant {
	...
	public static final class NaviTable implements BaseColumns {
		...
		public static final String SQL_CMD_CREATE_TABLE = "create table "
				+ TABLE_NAME + " (" + _ID
				+ " integer primary key autoincrement, " + MANEUVER_IMAGE
				+ " text, " + NEXT_ROAD + " text, " + CURRENT_ROADNAME
				+ " text, " + NEXT_ROAD_DISTANCE + " integer, "
				+ TOTAL_REMAIN_TIME + " integer, " + TOTAL_REMAIN_DISTANCE
				+ " integer, " + ISNAVING + " integer" + ")";
	...
	public static final class WeatherTable implements BaseColumns {
		...
		public static final String HEIGHTEMPERATURE = "highestTemperature";
		public static final String LOWTEMPERATURE = "lowestTemperature";
		public static final String WIND = "wind";
		public static final String IMAGERES = "imageres";

		public static final String SQL_CMD_CREATE_TABLE = "create table "
				+ TABLE_NAME + " (" + _ID
				+ " integer primary key autoincrement, "  + DAY + " int, "+ CITY + " text, "
				+ WEATHER + " text, " + WIND + " text, " + TEMPERATURE
				+ " text, " + HEIGHTEMPERATURE + " text, " + LOWTEMPERATURE
				+ " text, " + IMAGERES + " text )";
