package com.console.buttoncontrol.utils;

public interface Contacts {
	
	public static final String DZ_KEYCODE0 = "com.console.DZ_KEYCODE0";
	public static final String DZ_KEYCODE1 = "com.console.DZ_KEYCODE1";
	public static final String DZ_KEYCODE2 = "com.console.DZ_KEYCODE2";
	public static final String DZ_KEYCODE3 = "com.console.DZ_KEYCODE3";
	public static final String DZ_KEYCODE4 = "com.console.DZ_KEYCODE4";
	public static final String DZ_KEYCODE5 = "com.console.DZ_KEYCODE5";
	public static final String DZ_KEYCODE6 = "com.console.DZ_KEYCODE6";
	
	public static final int K_VOLUP = 1;
	public static final int K_VOLDN = 2;
	public static final int K_AVMUTE = 3;
	public static final int K_PALYPAUSE = 4;
	public static final int K_PREV = 5;
	public static final int K_NEXT = 6;
	public static final int K_PHONE_UP = 7;
	public static final int K_HAND_UP = 8;
	public static final int K_POWER = 9;
	public static final int K_BACK = 10;
	public static final int K_MAINMENU = 11;
	public static final int SRC = 12;	
	public static final int TEL = 13;	
	public static final int MIC = 14;	
	public static final int K_MEUNDOWN_HANDUP = 15;
	public static final int K_MEUNUP_ANSWER = 16;	
	public static final int K_FM = 17;
	public static final int K_MUSIC = 18;
	public static final int K_NAV = 19;
