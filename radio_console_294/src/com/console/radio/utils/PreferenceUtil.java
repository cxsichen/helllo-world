...
public class PreferenceUtil {
	...
	public static final String KEY_LAYOUT_SETTING = "layout_setting";
	...
	public static int getLayoutSetting(Context context) {
		SharedPreferences pref = getPreferences(context);
		return pref.getInt(KEY_LAYOUT_SETTING, 0);
	}

	public static void setLayoutSetting(Context context, int value) {
		SharedPreferences.Editor editor = getPreferencesEditor(context);
		editor.putInt(KEY_LAYOUT_SETTING, value).apply();
	}
