...
public class ObdView_294 extends ViewPageFactory {
	...
	ImageView icFuel;
	ImageView speedHand;
	ImageView speedHand1;
	Context mContext;

	DecimalFormat fnum = new DecimalFormat("##0.00");

	public ObdView_294(Context context, int layout) {
	...
	public void initView() {
		...
		speedHand1 = (ImageView) pageView.findViewById(R.id.speed_hand1);
...
/*		if (caninfo.BATTERY_VOLTAGE != -1)
		...
		if (caninfo.FUEL_WARING_SIGN == 1) {
			icFuel.setImageResource(R.drawable.ic_oil_orange);
		} else {
			icFuel.setImageResource(R.drawable.ic_oil);
		}
...
/*			handbrake.setText(mContext.getResources().getString(
		...
		speedHand.setRotation(1.32f * caninfo.DRIVING_SPEED);
		speedHand1.setRotation(1.32f * caninfo.DRIVING_SPEED);
	}
