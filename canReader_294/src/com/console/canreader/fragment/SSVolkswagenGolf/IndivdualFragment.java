...
public class IndivdualFragment extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_activity_layout_12,
				container, false);
		initView(view);
		initFragment();
		return view;
	...
	private void initFragment() {
		...
		getActivity().getFragmentManager().beginTransaction()
				.replace(R.id.content_layout_12, settingsFragment).commit();
	}
	...
	public class SettingsFragment extends PreferenceFragment implements
		...
		IndivdualFragment settingActivity;
		...
		/*-----------set data----------------*/
		String[] swPreKey = {"DRIVING_MODE_INDIVDUAL_AirCon","DRIVING_MODE_INDIVDUAL_Steering"};
		String[] swPreMsg = {"5AA5038B0505","5AA5038B0506" };

		String[] listPreKey = {"DRIVING_MODE","DRIVING_MODE_INDIVDUAL_DCC","DRIVING_MODE_INDIVDUAL_DBL",
				"DRIVING_MODE_INDIVDUAL_Engine","DRIVING_MODE_INDIVDUAL_ACC"};
		String[] listPreMsg = {"5AA5","5AA5038B0501","5AA5038B0502",
				"5AA5038B0503","5AA5038B0504"};

		private void addListData(List<Integer> mListValueGroup2,
				CanInfo mCaninfo) {
			// TODO Auto-generated method stub
			mListValueGroup2.add(mCaninfo.DRIVING_MODE);
			mListValueGroup2.add(mCaninfo.DRIVING_MODE_INDIVDUAL_DCC);
			mListValueGroup2.add(mCaninfo.DRIVING_MODE_INDIVDUAL_DBL);
			mListValueGroup2.add(mCaninfo.DRIVING_MODE_INDIVDUAL_Engine);
			mListValueGroup2.add(mCaninfo.DRIVING_MODE_INDIVDUAL_ACC);
		}

		private void addSwitchData(List<Integer> mSwitchValueGroup2,
				CanInfo mCaninfo) {
			// TODO Auto-generated method stub
			mSwitchValueGroup2.add(mCaninfo.DRIVING_MODE_INDIVDUAL_AirCon);
			mSwitchValueGroup2.add(mCaninfo.DRIVING_MODE_INDIVDUAL_Steering);

		}

		/*-----------set data----------------*/

		public SettingsFragment(IndivdualFragment settingActivity) {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.ssgolf_setting_prefs_12);
			...
			p1=(Preference) findPreference("DRIVING_MODE_RESET");
				...
				if (key.equals(listPreKey[i])) {
					if (settingActivity != null) {
						try {
							...
							if(key.equals("DRIVING_MODE")){
								settingActivity.sendMsg("5AA5038B"
										+ BytesUtil.changIntHex(value)+"0000");
							}else{
		...
		public boolean onPreferenceClick(Preference preference) {
			...
			final String key = preference.getKey();
			if (settingActivity != null)
				settingActivity.sendMsg("5AA5038B050700");
			return true;
		}
