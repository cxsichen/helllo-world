...
public class SportFragment extends BaseFragment {
	...
	public class SettingsFragment extends PreferenceFragment implements
		...
		String[] listPreKey = {"ESC_SYSTEM",};
		String[] listPreMsg = {"5AA5028A03"};
		...
		public SettingsFragment(SportFragment settingActivity) {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.ssgolf_setting_prefs_11);
