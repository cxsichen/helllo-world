...
public class AirContorlActivity extends AirConBaseActivity implements
	...
	private void initView() {
		...
		LEFT_SEAT_TEMP.setOnTouchListener(this);
		RIGTHT_SEAT_TEMP.setOnTouchListener(this);
	...
	public void syncView(CanInfo mCaninfo) {
		try {
			...
			SYNC.setBackgroundResource(mCaninfo.DAUL_LAMP_INDICATOR == 0 ? R.drawable.bg_button_oval
					: R.drawable.bg_button_oval_on);
			AUTO_STATUS
	...
	public boolean onTouch(View v, MotionEvent event) {
		// TODO Auto-generated method stub
		switch (v.getId()) {
		case R.id.LEFT_SEAT_TEMP:
			if (event.getAction() == MotionEvent.ACTION_DOWN)
				sendMsg("5AA5023D1101");
			if (event.getAction() == MotionEvent.ACTION_UP)
				sendMsg("5AA5023D1100");
			break;
		case R.id.RIGTHT_SEAT_TEMP:
			if (event.getAction() == MotionEvent.ACTION_DOWN)
				sendMsg("5AA5023D1201");
			if (event.getAction() == MotionEvent.ACTION_UP)
				sendMsg("5AA5023D1200");
			break;
		...
		case R.id.REAR_LAMP_INDICATOR:
			if (event.getAction() == MotionEvent.ACTION_DOWN)
				sendMsg("5AA5023D0601");
			if (event.getAction() == MotionEvent.ACTION_UP)
				sendMsg("5AA5023D0600");
			break;
