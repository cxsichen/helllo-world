...
public class UnitFragment1 extends BaseFragment {
	...
	public class SettingsFragment extends PreferenceFragment implements
		...
		String[] swPreKey = { "UNIT_TEMPERATURE","UNIT_CONSUMPTION","UNIT_TYPE"};
		String[] swPreMsg = { "5AA502CA03","5AA502CA05","5AA502CA07"};
		...
		public SettingsFragment(UnitFragment1 settingActivity) {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.ssfr_unit_setting_prefs);
			...
			getPreferenceScreen().removePreference(findPreference("UNIT_PRESSURE"));
		...
		public void syncView(CanInfo mCaninfo) {
			...
			mSwitchValueGroup.add(mCaninfo.UNIT_TEMPERATURE-1);
			mSwitchValueGroup.add(mCaninfo.UNIT_CONSUMPTION-1);
			mSwitchValueGroup.add(mCaninfo.UNIT_TYPE-1);
