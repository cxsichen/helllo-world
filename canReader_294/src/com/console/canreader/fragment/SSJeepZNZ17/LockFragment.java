...
public class LockFragment extends BaseFragment {
	...
	public class SettingsFragment extends PreferenceFragment implements
		...
		String[] swPreKey = { "REMOTELOCK_SIDELAMP_SIGN","SPEECH_WARING_VOLUME","REMOTE_START_SYSTEM",
				"REMOTECONTROL_LOCK_FEEDBACK","REMOTECONTROL_UNLOCK_FEEDBACK"};
		String[] swPreMsg = { "5AA5026107","5AA5026104","5AA5026103",
				"5AA5026102","5AA5026101"};

		List<ListPreference> mListPreferenceGroup = new ArrayList<ListPreference>();
		List<Integer> mListValueGroup = new ArrayList<Integer>();
		String[] listPreKey = {"REMOTELOCK_BEEP_SIGN"};
		String[] listPreMsg = {"5AA5026106"};

		public SettingsFragment(LockFragment settingActivity) {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.ssznz17_lock_setting_prefs);
		...
		public void syncView(CanInfo mCaninfo) {
			...
			mSwitchValueGroup.add(mCaninfo.REMOTELOCK_SIDELAMP_SIGN);
			mSwitchValueGroup.add(mCaninfo.SPEECH_WARING_VOLUME);
			mSwitchValueGroup.add(mCaninfo.REMOTE_START_SYSTEM);
			
			mSwitchValueGroup.add(mCaninfo.REMOTECONTROL_LOCK_FEEDBACK);
			...
			mListValueGroup.add(mCaninfo.REMOTELOCK_BEEP_SIGN);
