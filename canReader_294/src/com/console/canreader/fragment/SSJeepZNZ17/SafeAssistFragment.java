...
public class SafeAssistFragment extends BaseFragment {
	...
	public class SettingsFragment extends PreferenceFragment implements
		...
		String[] swPreKey = { "RADAR_PARK","AUTO_PARK_CAR_STATUS","CONVENIENCE_SEAT_PARK_MOVE",
				"DAYTIME_LAMP_STATUS","CONVENIENCE_RIPE_PARK_MOVE"};
		String[] swPreMsg = { "5AA5024405","5AA502440C","5AA5024407",
				"5AA5024410","5AA5024409"};

		List<ListPreference> mListPreferenceGroup = new ArrayList<ListPreference>();
		List<Integer> mListValueGroup = new ArrayList<Integer>();
		String[] listPreKey = {"GO_HOME_LAMP_STATUS"};
		String[] listPreMsg = {"5AA502440E"};
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.ssznz17_safe_setting_prefs);
