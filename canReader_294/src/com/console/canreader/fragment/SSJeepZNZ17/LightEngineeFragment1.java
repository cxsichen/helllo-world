...
public class LightEngineeFragment1 extends BaseFragment {
	...
	OnStepPreferenceClickListener,OnPreferenceChangeListener {
		...
		LightEngineeFragment1 settingActivity;
		...
		String[] swPreKey = { "CHANGE_ILL_STATUS","CHANGE_ILL_STATUS_ENABLE",
				"ESP_ENABLE","HOLOGRAM_ENABLE","CAT_SETTTING_ENABLE"};
		String[] swPreMsg = { "5AA502630A","5AA5026306",
		...
		public SettingsFragment(LightEngineeFragment1 settingActivity) {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			getPreferenceScreen().removePreference( findPreference("DAYTIME_LAMP_STATUS_ENABLE"));
