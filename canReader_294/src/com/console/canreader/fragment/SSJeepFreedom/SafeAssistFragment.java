...
public class SafeAssistFragment extends BaseFragment {
	...
	public class SettingsFragment extends PreferenceFragment implements
		...
		SafeAssistFragment settingActivity;
		...
		String[] swPreKey = { "RADAR_PARK","DETECT_FRONT_CAR","FRONT_DANGER_WAIRNG_DISTANCE",
				"AUTO_PARK_CAR_STATUS","PARKING_STATUS","CONVENIENCE_REVERSE_BACKWIPE_AUTO",
				"CONVENIENCE_SEAT_PARK_MOVE","CONVENIENCE_RIPE_PARK_MOVE","DAYTIME_LAMP_STATUS",
				"AUTO_LAMP_STATUS"};
		String[] swPreMsg = { "5AA5024405","5AA5024402","5AA5024401",
				"5AA502440C","5AA502440B","5AA502440A",
				"5AA5024407","5AA5024408","5AA5024410","5AA502440F"};

		List<ListPreference> mListPreferenceGroup = new ArrayList<ListPreference>();
		List<Integer> mListValueGroup = new ArrayList<Integer>();
		String[] listPreKey = {"LANE_DEPARTURE","PAUSE_LKAS_SIGN","CRASHPROOF_SIDE_BLIND_AREA",
				"FOG_LAMP_STATUS","GO_HOME_LAMP_STATUS","WELCOME_PERSION_ILL_STATUS"};
		String[] listPreMsg = {"5AA5024404","5AA5024403","5AA5024406",
				"5AA5024411","5AA502440E","5AA502440D"};

		public SettingsFragment(SafeAssistFragment settingActivity) {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.ssfr_safe_setting_prefs);
		...
		public void syncView(CanInfo mCaninfo) {
			...
			mSwitchValueGroup.add(mCaninfo.RADAR_PARK);
			mSwitchValueGroup.add(mCaninfo.DETECT_FRONT_CAR);
			mSwitchValueGroup.add(mCaninfo.FRONT_DANGER_WAIRNG_DISTANCE);
			
			mSwitchValueGroup.add(mCaninfo.AUTO_PARK_CAR_STATUS);
			mSwitchValueGroup.add(mCaninfo.PARKING_STATUS);
			mSwitchValueGroup.add(mCaninfo.CONVENIENCE_REVERSE_BACKWIPE_AUTO);
			mSwitchValueGroup.add(mCaninfo.CONVENIENCE_SEAT_PARK_MOVE);
			mSwitchValueGroup.add(mCaninfo.CONVENIENCE_RIPE_PARK_MOVE);
			
			mSwitchValueGroup.add(mCaninfo.DAYTIME_LAMP_STATUS);
			mSwitchValueGroup.add(mCaninfo.AUTO_LAMP_STATUS);
			...
			mListValueGroup.add(mCaninfo.LANE_DEPARTURE);
			mListValueGroup.add(mCaninfo.PAUSE_LKAS_SIGN);
			mListValueGroup.add(mCaninfo.CRASHPROOF_SIDE_BLIND_AREA);
			
			mListValueGroup.add(mCaninfo.FOG_LAMP_STATUS);
			mListValueGroup.add(mCaninfo.GO_HOME_LAMP_STATUS);
			mListValueGroup.add(mCaninfo.WELCOME_PERSION_ILL_STATUS);
