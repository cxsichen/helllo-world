...
public class TpmsActivity extends BaseActivity {
	...
	public void show(CanInfo mCaninfo) {
		...
		super.show(mCaninfo);
		if (mCaninfo != null) {
			if (mCaninfo.TPMS_FL_PRESSUE == -1) {
				updateTextView(pressure_fl, "--");
				updateTextView(pressure_fr, "--");
				updateTextView(pressure_bl, "--");
				updateTextView(pressure_br, "--");
			} else {
	...
	private void initView() {
		...
		temperature_fl.setVisibility(View.INVISIBLE);
		temperature_fr.setVisibility(View.INVISIBLE);
		temperature_bl.setVisibility(View.INVISIBLE);
		temperature_br.setVisibility(View.INVISIBLE);
