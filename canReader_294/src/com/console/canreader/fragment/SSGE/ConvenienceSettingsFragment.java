...
public class ConvenienceSettingsFragment extends BaseFragment {
	...
	public class SettingsFragment extends PreferenceFragment implements
		...
		ConvenienceSettingsFragment settingActivity;
		...
		String[] swPreKey = { "CONVENIENCE_SEAT_PARK_MOVE",
				"CONVENIENCE_OUTERMIRROR_PARK_LEAN",
		...
		String[] listPreKey = { "CONVENIENCE_RIPE_PARK_MOVE" };
		String[] listPreMsg = { "5AA5025A030" };

		public SettingsFragment(ConvenienceSettingsFragment settingActivity) {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.ssge_convience_setting_prefs);
		...
		public void syncView(CanInfo mCaninfo) {
			...
			mSwitchValueGroup.add(mCaninfo.CONVENIENCE_OUTERMIRROR_PARK_LEAN);
			mSwitchValueGroup.add(mCaninfo.CONVENIENCE_OUTERMIRROR_PARK_FOLD);
			mSwitchValueGroup.add(mCaninfo.CONVENIENCE_DRIVER_PRIVATE_SETTING);
			mSwitchValueGroup.add(mCaninfo.CONVENIENCE_REVERSE_BACKWIPE_AUTO);
			mSwitchValueGroup.add(mCaninfo.CONVENIENCE_RIPE_PARK_LEAN);
			mSwitchValueGroup.add(mCaninfo.CONVENIENCE_AUTO_WIPE);
			...
			mListValueGroup.add(mCaninfo.CONVENIENCE_RIPE_PARK_MOVE);
