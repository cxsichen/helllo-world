package com.console.canreader.fragment.SSVolkswagen;
...
public class AssitFragment extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_activity_layout_11,
				container, false);
		initView(view);
		initFragment();
		return view;
	...
	private void initFragment() {
		...
		getActivity().getFragmentManager().beginTransaction()
				.replace(R.id.content_layout_11, settingsFragment).commit();
	}
	...
	public class SettingsFragment extends PreferenceFragment implements
		...
		/*-----------set data----------------*/
		String[] swPreKey = {"STOPING_STATUS","REVERSE_GEAR_STATUS","RADAR_ALARM_STATUS_ENABLE"};
		String[] swPreMsg = { "AA55024C09","AA55024C0A","AA55024C0B" };
		...
		private void addSwitchData(List<Integer> mSwitchValueGroup2,
				CanInfo mCaninfo) {
			// TODO Auto-generated method stub
			mSwitchValueGroup2.add(mCaninfo.STOPING_STATUS);
			mSwitchValueGroup2.add(mCaninfo.REVERSE_GEAR_STATUS);
			mSwitchValueGroup2.add(mCaninfo.RADAR_ALARM_STATUS_ENABLE);
		}

		/*-----------set data----------------*/

		public SettingsFragment(AssitFragment settingActivity) {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.ssv_setting_prefs);
