...
public class LockSettingsFragment extends BaseFragment {
	...
	public class SettingsFragment extends PreferenceFragment implements
		...
		String[] swPreKey = { "DOOR_UNLOCKING", "AUTOMATIC_LOCKING"};
		String[] swPreMsg = { "5AA5026B02", "5AA5026B01" };
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.ssjy_lock_setting_prefs);
		...
		public void syncView(CanInfo mCaninfo) {
			...
			mSwitchValueGroup.add(mCaninfo.DOOR_UNLOCKING);
			mSwitchValueGroup.add(mCaninfo.AUTOMATIC_LOCKING);
