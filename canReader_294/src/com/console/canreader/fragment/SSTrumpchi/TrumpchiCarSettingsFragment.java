...
public class TrumpchiCarSettingsFragment extends BaseFragment {
	...
	public class SettingsFragment extends PreferenceFragment implements
		...
		private void initView() {
			...
			car_info_DRIVING_POSITION_SETTING
					.setOnPreferenceChangeListener(this);
			car_info_DEPUTY_DRIVING_POSITION_SETTING
					.setOnPreferenceChangeListener(this);
			car_info_POSITION_WELCOME_SETTING
					.setOnPreferenceChangeListener(this);
		...
		public void syncView(CanInfo mCaninfo) {
			...
			car_info_LANGUAGE_CHANGE
					.setSummary(mCaninfo.LANGUAGE_CHANGE == 1 ? a[0].toString()
							: a[1].toString());
			a = car_info_AIR_COMFORTABLE_STATUS.getEntries();
			car_info_AIR_COMFORTABLE_STATUS
					.setSummary(a[mCaninfo.AIR_COMFORTABLE_STATUS].toString());
			a = car_info_WARNING_VOLUME.getEntries();
			car_info_WARNING_VOLUME.setSummary(a[mCaninfo.WARNING_VOLUME]
					.toString());
			a = car_info_DRIVER_CHANGE_MODE.getEntries();
			car_info_DRIVER_CHANGE_MODE
					.setSummary(a[mCaninfo.DRIVER_CHANGE_MODE].toString());
			a = car_info_REMOTE_UNLOCK.getEntries();
			car_info_REMOTE_UNLOCK.setSummary(a[mCaninfo.REMOTE_UNLOCK]
					.toString());
			a = car_info_GO_HOME_LAMP_STATUS.getEntries();
			car_info_GO_HOME_LAMP_STATUS
					.setSummary(a[mCaninfo.GO_HOME_LAMP_STATUS].toString());
			a = car_info_AUTO_LAMP_STATUS.getEntries();
			car_info_AUTO_LAMP_STATUS.setSummary(a[mCaninfo.AUTO_LAMP_STATUS]
					.toString());

			car_info_AUTO_COMPRESSOR_STATUS
					.setChecked(mCaninfo.AUTO_COMPRESSOR_STATUS == 1 ? true
							: false);
			car_info_AUTO_CYCLE_STATUS
					.setChecked(mCaninfo.AUTO_CYCLE_STATUS == 1 ? true : false);
			car_info_AIR_ANION_STATUS
					.setChecked(mCaninfo.AIR_ANION_STATUS == 1 ? true : false);
			car_info_DRIVING_POSITION_SETTING
					.setChecked(mCaninfo.DRIVING_POSITION_SETTING == 1 ? true
							: false);
			car_info_DEPUTY_DRIVING_POSITION_SETTING
					.setChecked(mCaninfo.DEPUTY_DRIVING_POSITION_SETTING == 1 ? true
							: false);
			car_info_POSITION_WELCOME_SETTING
					.setChecked(mCaninfo.POSITION_WELCOME_SETTING == 1 ? true
							: false);
			car_info_KEY_INTELLIGENCE
					.setChecked(mCaninfo.KEY_INTELLIGENCE == 1 ? true : false);
			car_info_SPEED_LOCK.setChecked(mCaninfo.SPEED_LOCK == 1 ? true
					: false);
			car_info_AUTO_UNLOCK.setChecked(mCaninfo.AUTO_UNLOCK == 1 ? true
					: false);
			car_info_REMOTE_FRONT_LEFT
					.setChecked(mCaninfo.REMOTE_FRONT_LEFT == 1 ? true : false);
			car_info_FRONT_WIPER_CARE
					.setChecked(mCaninfo.FRONT_WIPER_CARE == 1 ? true : false);
			car_info_REAR_WIPER_STATUS
					.setChecked(mCaninfo.REAR_WIPER_STATUS == 1 ? true : false);
			car_info_OUTSIDE_MIRROR_STATUS
					.setChecked(mCaninfo.OUTSIDE_MIRROR_STATUS == 1 ? true
							: false);
			car_info_FOG_LAMP_STATUS
					.setChecked(mCaninfo.FOG_LAMP_STATUS == 1 ? true : false);
			car_info_DAYTIME_LAMP_STATUS
					.setChecked(mCaninfo.DAYTIME_LAMP_STATUS == 1 ? true
							: false);

			String b = "";
			b = String.valueOf(mCaninfo.SPEED_OVER_SETTING)
					+ getString(R.string.str_kmh);
			car_info_SPEED_OVER_SETTING.setSummary(b);
			b = String.valueOf(mCaninfo.REMOTE_POWER_TIME)
					+ getString(R.string.str_minute);
			car_info_REMOTE_POWER_TIME.setSummary(b);
			b = String.valueOf(mCaninfo.REMOTE_START_TIME)
					+ getString(R.string.str_minute);
		...
		public boolean onPreferenceChange(Preference preference, Object newValue) {
			...
			case "car_info_LANGUAGE_CHANGE":
				if (settingActivity != null) {
					...
					settingActivity.sendMsg("5AA5029B01"
							+ (value == 1 ? "00" : "01"));
				}
				break;
			case "car_info_AUTO_COMPRESSOR_STATUS":
				if (settingActivity != null) {
					settingActivity.sendMsg("5AA5029B02"
							+ ((boolean) newValue ? "01" : "00"));
				}
				break;
			case "car_info_AUTO_CYCLE_STATUS":
				if (settingActivity != null) {
					settingActivity.sendMsg("5AA5029B03"
							+ ((boolean) newValue ? "01" : "00"));
				}
				break;
			...
			case "car_info_SPEED_OVER_SETTING":
				if (settingActivity != null) {
					int value = Integer.parseInt((String) newValue);
					settingActivity.sendMsg("5AA5029B07"
							+ BytesUtil.intToHexString(value / 10));
				}
				break;
			case "car_info_WARNING_VOLUME":
				if (settingActivity != null) {
					int value = Integer.parseInt((String) newValue);
					settingActivity.sendMsg("5AA5029B08"
							+ BytesUtil.intToHexString(value));
				}
				break;
			case "car_info_REMOTE_POWER_TIME":
				if (settingActivity != null) {
					int value = Integer.parseInt((String) newValue);
					settingActivity.sendMsg("5AA5029B09"
							+ BytesUtil.intToHexString(value));
				}
				break;
			case "car_info_REMOTE_START_TIME":
				if (settingActivity != null) {
					int value = Integer.parseInt((String) newValue);
					settingActivity.sendMsg("5AA5029B0A"
							+ BytesUtil.intToHexString(value));
				}
			...
			case "car_info_DRIVER_CHANGE_MODE":
				if (settingActivity != null) {
					int value = Integer.parseInt((String) newValue);
					settingActivity.sendMsg("5AA5029B0B"
							+ BytesUtil.intToHexString(value));
				}
				break;
			case "car_info_REMOTE_UNLOCK":
				if (settingActivity != null) {
					int value = Integer.parseInt((String) newValue);
					settingActivity.sendMsg("5AA5029B0C"
							+ BytesUtil.intToHexString(value));
				}
				break;
			case "car_info_SPEED_LOCK":
				if (settingActivity != null) {
					settingActivity.sendMsg("5AA5029B0D"
							+ ((boolean) newValue ? "01" : "00"));
				}
				break;
			case "car_info_AUTO_UNLOCK":
				if (settingActivity != null) {
					settingActivity.sendMsg("5AA5029B0E"
							+ ((boolean) newValue ? "01" : "00"));
				}
				break;
			case "car_info_REMOTE_FRONT_LEFT":
				if (settingActivity != null) {
					settingActivity.sendMsg("5AA5029B0F"
							+ ((boolean) newValue ? "01" : "00"));
				}
				break;
			...
			case "car_info_FRONT_WIPER_CARE":// /
				if (settingActivity != null) {
					settingActivity.sendMsg("5AA5029B10"
							+ ((boolean) newValue ? "01" : "00"));
				}
				break;
			case "car_info_REAR_WIPER_STATUS":
				if (settingActivity != null) {
					settingActivity.sendMsg("5AA5029B11"
							+ ((boolean) newValue ? "01" : "00"));
				}
				break;
			case "car_info_OUTSIDE_MIRROR_STATUS":
				if (settingActivity != null) {
					settingActivity.sendMsg("5AA5029B19"
							+ ((boolean) newValue ? "01" : "00"));
				}
				break;
			case "car_info_GO_HOME_LAMP_STATUS":
				if (settingActivity != null) {
					int value = Integer.parseInt((String) newValue);
					settingActivity.sendMsg("5AA5029B12"
							+ BytesUtil.intToHexString(value));
				}
				break;
			case "car_info_FOG_LAMP_STATUS":
				if (settingActivity != null) {
					settingActivity.sendMsg("5AA5029B13"
							+ ((boolean) newValue ? "01" : "00"));
				}
				break;
			case "car_info_DAYTIME_LAMP_STATUS":
				if (settingActivity != null) {
					settingActivity.sendMsg("5AA5029B14"
							+ ((boolean) newValue ? "01" : "00"));
				}
				break;
			case "car_info_AUTO_LAMP_STATUS":// /
				if (settingActivity != null) {
					int value = Integer.parseInt((String) newValue);
					settingActivity.sendMsg("5AA5029B15"
							+ BytesUtil.intToHexString(value));
				}
				break;
