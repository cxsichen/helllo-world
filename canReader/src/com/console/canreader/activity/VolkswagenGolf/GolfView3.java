...
public class GolfView3 extends ViewPageFactory {
	...
	public void showView(CanInfo caninfo) {
        ...
        if(caninfo.TRAVELLINGTIME_LONG_TERM/60>0){
        	travelling_time.setText(caninfo.TRAVELLINGTIME_LONG_TERM/60+mContext.getResources().getString(R.string.hour)+caninfo.TRAVELLINGTIME_LONG_TERM%60+mContext.getResources().getString(R.string.minute));
        }else{
        	travelling_time.setText(caninfo.TRAVELLINGTIME_LONG_TERM%60+mContext.getResources().getString(R.string.minute));
        }
