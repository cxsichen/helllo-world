package com.console.canreader.fragment.SSJY;
...
public class LightSettingsFragment extends BaseFragment {
	...
	public class SettingsFragment extends PreferenceFragment implements
		...
		String[] listPreKey = {"LIGHT_TOP_LIGHT", "AUTOMATIC_LAMP_CLOSE"};
		String[] listPreMsg = {"5AA5026C02", "5AA5026C01"};
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.ssjy_light_setting_prefs);
		...
		public void syncView(CanInfo mCaninfo) {
			...
			mListValueGroup.add(mCaninfo.LIGHT_TOP_LIGHT);
			mListValueGroup.add(mCaninfo.AUTOMATIC_LAMP_CLOSE);
