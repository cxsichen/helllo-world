...
public class GS5CarEnableInfoFragment extends BaseFragment {
	...
	public class SettingsFragment extends PreferenceFragment implements
		...
		private Preference panorama_enable;

		GS5CarEnableInfoFragment settingActivity;

		public SettingsFragment(GS5CarEnableInfoFragment settingActivity) {
		...
		private void initView() {
			panorama_enable = findPreference("ESP_enable");
		}

		public void syncView(CanInfo mCanInfo) {
			panorama_enable
					.setSummary(mCanInfo.HOLOGRAM_ENABLE == 0 ? R.string.car_info_unable
