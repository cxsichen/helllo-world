...
public class GS4CarEnableInfoFragment extends BaseFragment {
	...
	public class SettingsFragment extends PreferenceFragment implements
		...
		private Preference setting_enable;
		private Preference panel_enable;
		private Preference AIR_enable;

		GS4CarEnableInfoFragment settingActivity;

		public SettingsFragment(GS4CarEnableInfoFragment settingActivity) {
		...
		private void initView() {
			...
			setting_enable = findPreference("setting_enable");
		...
		public void syncView(CanInfo mCanInfo) {
			...
			setting_enable
					.setSummary(mCanInfo.CAT_SETTTING_ENABLE == 0 ? R.string.car_info_unable
							: R.string.car_info_enable);
			panel_enable
