...
public class DisplaySettingsFragment extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_activity_layout_7,
				container, false);
		initView(view);
		initFragment();
		return view;
	...
	private void initFragment() {
		...
		getActivity().getFragmentManager().beginTransaction()
				.replace(R.id.content_layout_7, settingsFragment).commit();
	}
	...
	public class SettingsFragment extends PreferenceFragment implements
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.ssge_display_setting_prefs);
		...
		public void syncView(CanInfo mCaninfo) {
			...
			mSwitchValueGroup.add(mCaninfo.DISPLAY_SPEED_RANG);
