...
public class BluetoothSettingsFragment extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.ssge_bluetooth_layout, container,
				false);
		initView(view);
		initFragment();
		return view;
	...
	public void show(CanInfo mCaninfo) {
		...
		super.show(mCaninfo);
		if (mCaninfo != null) {
			tv.setText(mCaninfo.BLUETOOTH_NAME);
			tv1.setText(mCaninfo.BLUETOOTH_PASSWARD);
		}
	}
	...
	private void initView(View view) {
		tv = (TextView) view.findViewById(R.id.bluetooth_name);
		tv1 = (TextView) view.findViewById(R.id.bluetooth_passward);
