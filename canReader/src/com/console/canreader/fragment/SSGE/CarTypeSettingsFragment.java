...
public class CarTypeSettingsFragment extends BaseFragment {
	...
	public class SettingsFragment extends PreferenceFragment implements
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.ssge_cartype_setting_prefs);
		...
		public void syncView(CanInfo mCaninfo) {
			updatePreferenceDescription(p2,mCaninfo.CAR_TYPE);
		}
			...
			case "CAR_TYPE":
				if (settingActivity != null) {
					try {
		                ...
		                settingActivity.sendMsg("5AA5022A0"+String.valueOf(value)+"00");
