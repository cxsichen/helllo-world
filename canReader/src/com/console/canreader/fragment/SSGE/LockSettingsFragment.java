...
public class LockSettingsFragment extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_activity_layout_4,
				container, false);
		initView(view);
		initFragment();
		return view;
	...
	private void initFragment() {
		...
		getActivity().getFragmentManager().beginTransaction()
				.replace(R.id.content_layout_4, settingsFragment).commit();
	}
	...
	public class SettingsFragment extends PreferenceFragment implements
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.ssge_lock_setting_prefs);
		...
		public void syncView(CanInfo mCaninfo) {
			...
			mSwitchValueGroup.add(mCaninfo.LOCK_OPENDOOR_WITHOUTLOCK);
			mSwitchValueGroup.add(mCaninfo.AUTO_LOCK_SETTING);
			mSwitchValueGroup.add(mCaninfo.LOCK_DELAY_LOCK);
			...
			mListValueGroup.add(mCaninfo.AUTO_OPEN_LOCK_Z);
			mListValueGroup.add(mCaninfo.AUTO_OPEN_LOCK_S);
