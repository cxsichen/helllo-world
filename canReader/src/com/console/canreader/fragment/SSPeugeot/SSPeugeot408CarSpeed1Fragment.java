...
public class SSPeugeot408CarSpeed1Fragment extends BaseFragment {
	...
	private OnSeekBarChangeListener seekBarListenenr = new OnSeekBarChangeListener() {
		...
		public void onStopTrackingTouch(SeekBar seekBar) {
			...
			String s1 = BytesUtil.intToHexString(REMEMBER_SPEED_1_VALUE_S
					.getProgress());
			String s2 = BytesUtil.intToHexString(REMEMBER_SPEED_2_VALUE_S
					.getProgress());
			String s3 = BytesUtil.intToHexString(REMEMBER_SPEED_3_VALUE_S
					.getProgress());
			String s4 = BytesUtil.intToHexString(REMEMBER_SPEED_4_VALUE_S
					.getProgress());
			String s5 = BytesUtil.intToHexString(REMEMBER_SPEED_5_VALUE_S
					.getProgress());
			String s6 = BytesUtil.intToHexString(REMEMBER_SPEED_6_VALUE_S
					.getProgress());
			Log.i("xxx", "s1=" + s1);
			Log.i("xxx", "s2=" + s2);
			Log.i("xxx", "s3=" + s3);
			...
			int vC = (v0 << 7) + (v1 << 6) + (v2 << 5) + (v3 << 4) + (v4 << 3)
					+ (v5 << 2) + (v6 << 1);
			sendMsg("5AA50A8A" + BytesUtil.intToHexString(vC) + s1 + s2 + s3
					+ s4 + s5 + s6 + "000000");
		}
		...
		public void onProgressChanged(SeekBar seekBar, int progress,
				boolean fromUser) {
			try {
				REMEMBER_SPEED_1_VALUE.setText(""
						+ REMEMBER_SPEED_1_VALUE_S.getProgress());
				REMEMBER_SPEED_2_VALUE.setText(""
						+ REMEMBER_SPEED_2_VALUE_S.getProgress());
				REMEMBER_SPEED_3_VALUE.setText(""
						+ REMEMBER_SPEED_3_VALUE_S.getProgress());
				REMEMBER_SPEED_4_VALUE.setText(""
						+ REMEMBER_SPEED_4_VALUE_S.getProgress());
				REMEMBER_SPEED_5_VALUE.setText(""
						+ REMEMBER_SPEED_5_VALUE_S.getProgress());
				REMEMBER_SPEED_6_VALUE.setText(""
						+ REMEMBER_SPEED_6_VALUE_S.getProgress());
			} catch (Exception e) {
	...
	private OnCheckedChangeListener onCheckedChangeListener = new OnCheckedChangeListener() {
		...
		public void onCheckedChanged(CompoundButton buttonView,
			...
			int vC = (v0 << 7) + (v1 << 6) + (v2 << 5) + (v3 << 4) + (v4 << 3)
					+ (v5 << 2) + (v6 << 1);
			String s1 = BytesUtil
					.intToHexString(mCanInfo.REMEMBER_SPEED_1_VALUE);
			String s2 = BytesUtil
					.intToHexString(mCanInfo.REMEMBER_SPEED_2_VALUE);
			String s3 = BytesUtil
					.intToHexString(mCanInfo.REMEMBER_SPEED_3_VALUE);
			String s4 = BytesUtil
					.intToHexString(mCanInfo.REMEMBER_SPEED_4_VALUE);
			String s5 = BytesUtil
					.intToHexString(mCanInfo.REMEMBER_SPEED_5_VALUE);
			String s6 = BytesUtil
					.intToHexString(mCanInfo.REMEMBER_SPEED_6_VALUE);
	...
	private void syncView(CanInfo canInfo) {
		try {
			...
			REMEMBER_SPEED_1_VALUE_S
					.setProgress(canInfo.REMEMBER_SPEED_1_VALUE);
			REMEMBER_SPEED_2_VALUE_S
					.setProgress(canInfo.REMEMBER_SPEED_2_VALUE);
			REMEMBER_SPEED_3_VALUE_S
					.setProgress(canInfo.REMEMBER_SPEED_3_VALUE);
			REMEMBER_SPEED_4_VALUE_S
					.setProgress(canInfo.REMEMBER_SPEED_4_VALUE);
			REMEMBER_SPEED_5_VALUE_S
					.setProgress(canInfo.REMEMBER_SPEED_5_VALUE);
			REMEMBER_SPEED_6_VALUE_S
					.setProgress(canInfo.REMEMBER_SPEED_6_VALUE);
			...
			if (REMEMBER_SPEED_STATUS.isChecked()) {
				...
				REMEMBER_SPEED_1_VALUE_S.setEnabled(REMEMBER_SPEED_1
						.isChecked());
				REMEMBER_SPEED_2_VALUE_S.setEnabled(REMEMBER_SPEED_2
						.isChecked());
				REMEMBER_SPEED_3_VALUE_S.setEnabled(REMEMBER_SPEED_3
						.isChecked());
				REMEMBER_SPEED_4_VALUE_S.setEnabled(REMEMBER_SPEED_4
						.isChecked());
				REMEMBER_SPEED_5_VALUE_S.setEnabled(REMEMBER_SPEED_5
						.isChecked());
				REMEMBER_SPEED_6_VALUE_S.setEnabled(REMEMBER_SPEED_6
						.isChecked());
			} else {
