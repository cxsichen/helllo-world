...
public class AirControlerSSPeugeot408 extends BaseActivity implements
		OnClickListener {
	...
	protected void initPopuptWindow() {
		...
		popupWindowView = getLayoutInflater().inflate(
				R.layout.ac_more_peugeot_408, null, false);
		// 点击其他地方消失
		...
		AIR_STRENGTH_LOW_iv = (RelativeLayout) popupWindowView
				.findViewById(R.id.AIR_STRENGTH_LOW_iv);
		AIR_STRENGTH_MIDDLE_iv = (RelativeLayout) popupWindowView
				.findViewById(R.id.AIR_STRENGTH_MIDDLE_iv);
		AIR_STRENGTH_HIGH_iv = (RelativeLayout) popupWindowView
				.findViewById(R.id.AIR_STRENGTH_HIGH_iv);
		...
		try {
			...
			if (mCaninfo.Mono_STATUS == 1) {
				if (mCaninfo.DRIVING_POSITON_TEMP == 0) {
					...
					left_temp_value
							.setText(mCaninfo.DRIVING_POSITON_TEMP + "°");
				}
				if (mCaninfo.DRIVING_POSITON_TEMP == 0) {
				...
				if (mCaninfo.DEPUTY_DRIVING_POSITON_TEMP == 0) {
					...
					right_temp_value
							.setText(mCaninfo.DEPUTY_DRIVING_POSITON_TEMP + "°");
				}
			...
			AC_INDICATOR_STATUS
					.setBackgroundResource(mCaninfo.AC_INDICATOR_STATUS == 0 ? R.drawable.bg_button_oval
							: R.drawable.bg_button_oval_on);
			AC_MAX_STATUS
					.setBackgroundResource(mCaninfo.AC_MAX_STATUS == 0 ? R.drawable.bg_button_oval
							: R.drawable.bg_button_oval_on);
			...
			if (mCaninfo.AIR_STRENGTH == 0) {
				AIR_STRENGTH_LOW_iv
						.setBackgroundResource(R.drawable.bg_button_oval_on);
				AIR_STRENGTH_MIDDLE_iv
						.setBackgroundResource(R.drawable.bg_button_oval);
				AIR_STRENGTH_HIGH_iv
						.setBackgroundResource(R.drawable.bg_button_oval);
			...
			Mono_STATUS
					.setBackgroundResource(mCaninfo.Mono_STATUS == 0 ? R.drawable.bg_button_oval
							: R.drawable.bg_button_oval_on);
	...
	public void onClick(View v) {
		try {
			...
			case R.id.CYCLE_INDICATOR:
				...
				Log.i("xyw",
						"CYCLE_INDICATOR=" + "5AA5023B07"
								+ BytesUtil.intToHexString(v6));
				break;
			...
			case R.id.Mono_STATUS:
				...
				Log.i("xxx",
						"--==" + "5AA5023B0F" + BytesUtil.intToHexString(v10));
				break;
			default:
				break;
			}
