...
public class KMRCarSettingsFragment extends BaseFragment {
	...
	OnPreferenceChangeListener {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			addPreferencesFromResource(R.xml.sskmr_setting_prefs);
			p1 = (SwitchPreference) findPreference("AUTO_LOCK_SETTING");
			p2 = (SwitchPreference) findPreference("AUTO_OPEN_LOCK");
			p3 = (SwitchPreference) findPreference("DRIVER_LINK_LOCK");
			p4 = (SwitchPreference) findPreference("AUTO_OPEN_LOCK_P");
			...
			p11 = (SwitchPreference) findPreference("TWICE_BUTTON_OPEN_LOCK");
