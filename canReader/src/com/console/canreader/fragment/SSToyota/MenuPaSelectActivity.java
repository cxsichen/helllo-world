...
public class MenuPaSelectActivity extends BaseActivity implements
	...
	public class SettingsFragment extends PreferenceFragment implements
		...
		public void onCreate(Bundle savedInstanceState) {
			// TODO Auto-generated method stub
			super.onCreate(savedInstanceState);
			addPreferencesFromResource(R.xml.equal_prefs);
			mAirConPref = (SwitchPreference) findPreference("VOL_LINK_CARSPEED");
		...
		public void syncView(CanInfo mCaninfo) {
			mAirConPref.setChecked(mCaninfo.VOL_LINK_CARSPEED == 1);
