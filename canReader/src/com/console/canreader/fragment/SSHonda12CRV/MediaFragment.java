...
public class MediaFragment extends BaseFragment implements OnClickListener {
	...
	public void show(CanInfo mCaninfo) {
		...
		if (mCaninfo != null) {
			...
			tv1.setText(mCaninfo.MULTI_MEIDA_SOURCE==0x0D?"USB":mCaninfo.MULTI_MEIDA_SOURCE==0x0E?"IPOD":"");
			tv2.setText(mCaninfo.MULTI_MEIDA_PLAYING_NUM+"");
			tv3.setText(mCaninfo.MULTI_MEIDA_WHOLE_NUM+"");
			tv4.setText(mCaninfo.MULTI_MEIDA_PLAYING_MINUTE+":"+mCaninfo.MULTI_MEIDA_PLAYING_SECOND);
