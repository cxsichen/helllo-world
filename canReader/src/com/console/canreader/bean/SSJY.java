...
public class SSJY extends AnalyzeUtils {
	// 数据类型
	...
	// 车身信息
	public static final int CAR_INFO_DATA_1 = 0x34;
	// 车身基本信息
	public static final int CAR_INFO_DATA_3 = 0xF0;
	// 车身基本信息
	public static final int CAR_INFO_DATA_5 = 0x41;
	// 车身基本信息
	public static final int CAR_INFO_DATA_6 = 0x66;
	// 车身基本信息
	public static final int CAR_INFO_DATA_7 = 0x67;
	...
	void analyzeCarInfoData_1(byte[] msg) {
		...
		mCanInfo.DRIVING_DISTANCE = (int) ((((int) (msg[8] & 0xff)) * 256 * 256
