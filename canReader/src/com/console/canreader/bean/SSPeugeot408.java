...
public class SSPeugeot408 extends AnalyzeUtils {
	// 数据类型
	...
	void analyzeRadarData(byte[] msg) {
		...
		Log.i("xxx", "mCanInfo.BACK_LEFT_DISTANCE=="
				+ mCanInfo.BACK_LEFT_DISTANCE);
		Log.i("xxx", "mCanInfo.BACK_MIDDLE_LEFT_DISTANCE=="
				+ mCanInfo.BACK_MIDDLE_LEFT_DISTANCE);
		Log.i("xxx", "mCanInfo.BACK_MIDDLE_RIGHT_DISTANCE=="
				+ mCanInfo.BACK_MIDDLE_RIGHT_DISTANCE);
		Log.i("xxx", "mCanInfo.BACK_RIGHT_DISTANCE=="
				+ mCanInfo.BACK_RIGHT_DISTANCE);
		Log.i("xxx", "mCanInfo.DISTANCE==" + mCanInfo.FRONT_LEFT_DISTANCE);
		Log.i("xxx", "mCanInfo.DISTANCE=="
				+ mCanInfo.FRONT_MIDDLE_LEFT_DISTANCE);
		Log.i("xxx", "mCanInfo.DISTANCE=="
				+ mCanInfo.FRONT_MIDDLE_RIGHT_DISTANCE);
