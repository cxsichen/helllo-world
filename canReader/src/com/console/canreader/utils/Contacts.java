...
public class Contacts {
	...
	public final static class KEYEVENT {
		...
		public static final int POWER = 14; // 打开免打扰 app
		public static final int FM_AM = 15; // 打开radio app
		public static final int MUSIC = 16; // 打开音乐app
		public static final int PHONE_APP = 17; // 打开蓝牙电话app
		public static final int HOME = 18; // 返回主界面
		public static final int MAP = 19; // 打开地图
		public static final int AUX = 20; // 打开AUX
		public static final int MUSIC_PLAY_PAUSE = 21; // 打开音乐暂停和播放
		public static final int ANSWER_WITH_MENUUP = 22; // 接听键和上一曲
		public static final int HANGUP_WITH_MENUDOWN = 23; // 挂断键和下一曲
		public static final int NUM1 = 24; // 数字键1
		public static final int NUM2 = 25; // 数字键2
		public static final int NUM3 = 26; // 数字键3
		public static final int NUM4 = 27; // 数字键4
		public static final int NUM5 = 28; // 数字键5
		public static final int NUM6 = 29; // 数字键6
		public static final int NUM7 = 30; // 数字键7
		public static final int NUM8 = 31; // 数字键8
		public static final int NUM9 = 32; // 数字键9
		public static final int NUM0 = 33; // 数字键0
		public static final int NUMSTAR = 34; // 数字键*
		public static final int POUND = 35; // 数字键#
		public static final int DPAD_UP = 36; // 方向盘上
		public static final int DPAD_DOWN = 37; // 方向盘下
		public static final int DPAD_LEFT = 38; // 方向盘左
		public static final int DPAD_RIHGT = 39; // 方向盘右
		public static final int ENTER = 40; // 确认
		public static final int DEL = 41; // 删除
		public static final int BACK = 42; // 返回
		...
		public static final int CLOSERIGHTSIGHT = 108; // 关闭右视
		public static final int OPENRIGHTSIGHT= 109; // 打开右视
