...
public class SSHondaYG9CRVControl implements OnClickListener {
	...
	public SSHondaYG9CRVControl(MainActivity mMainActivity, RelativeLayout layout) {
		// TODO Auto-generated constructor stub
		this.mMainActivity = mMainActivity;
		this.context = mMainActivity;
		this.layout = layout;
		syncCanName();
		layout.findViewById(R.id.honda_15crv_layout)
	...
	private void initView() {
		...
		button1 = (Button) layout.findViewById(R.id.honda_button1);
		button2 = (Button) layout.findViewById(R.id.honda_button2);
		button3 = (Button) layout.findViewById(R.id.honda_button3);
	...
	public void onClick(View v) {
		// TODO Auto-generated method stub
		switch (v.getId()) {
		case R.id.honda_button1:
			sendMsg("5AA502F204FF");
			break;
		case R.id.honda_button2:
			sendMsg("5AA502F205FF");
			break;
		case R.id.honda_button3:
